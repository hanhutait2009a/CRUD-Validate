...
Route::get('/admin/experience', [\App\Http\Controllers\experience::class, 'showExperience']);
Route::post('/admin/experience', [\App\Http\Controllers\experience::class, 'store']);
